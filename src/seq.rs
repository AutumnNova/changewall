...
pub fn seq(colors:&ColorDict) -> String {
	...
	temp.push_str(&set_color(3, &colors.color10));
	temp.push_str(&set_color(4, &colors.color11));
	temp.push_str(&set_color(5, &colors.color12));
	temp.push_str(&set_color(6, &colors.color13));
	temp.push_str(&set_color(7, &colors.color14));
	temp.push_str(&set_color(8, &colors.color15));
	temp.push_str(&set_color(9, &colors.color8));
	temp.push_str(&set_color(10, &colors.color9));
	temp.push_str(&set_color(11, &colors.color10));
	temp.push_str(&set_color(12, &colors.color11));
	temp.push_str(&set_color(13, &colors.color12));
	temp.push_str(&set_color(14, &colors.color13));
	temp.push_str(&set_color(15, &colors.color14));
